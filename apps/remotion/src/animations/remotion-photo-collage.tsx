...
const PHOTOS = [
  ...
  { w: 1, h: 1, gradient: "linear-gradient(135deg, #f59e0b, #fbbf24)", label: "Portrait" },
...
const POSITIONS = [
  ...
  { col: 2, row: 0 },  // 1x1 Travel
  { col: 3, row: 0 },  // 1x1 Nature
  { col: 2, row: 1 },  // 1x1 Portrait
  { col: 3, row: 1 },  // 1x1 Food
  { col: 0, row: 2 },  // 2x1 Panorama
  { col: 2, row: 2 },  // 1x1 Art
  { col: 3, row: 2 },  // 1x1 Urban
];
